...
public class DeleteServiceImple implements DeleteService {
	private final static String delete = "delete from tblemployee where id=?,name=?,city=?";
	@Override
	public void DeleteEmp() throws IOException, SQLException, ClassNotFoundException {
