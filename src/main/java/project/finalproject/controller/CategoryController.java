...
public class CategoryController {
	...
	public ResponseEntity<Category> saveCategory(@RequestBody Category category) {
		...
		return new ResponseEntity<Category>(e1, HttpStatus.CREATED);
	}
	...
	public ResponseEntity<Category> singleCategoryData(@PathVariable int cid) {
		...
		return new ResponseEntity<Category>(e1, HttpStatus.OK);
	}
	...
	public ResponseEntity<List<Category>> allCategoryData() {
		...
		return new ResponseEntity<List<Category>>(l1, HttpStatus.OK);
	}
}
